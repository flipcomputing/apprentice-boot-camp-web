...
## Then create it as a view:
```
CREATE VIEW "sequel-mart-schema"."v_Web_Home_Transactions"
AS
SELECT 		sh.sale_id AS transaction, 
        cu.customer_name AS customer, 
        sh.date_sale AS date, 
...
## Then add a `SELECT` statement to that view into line 12 of routes/transactions.js
```
    `
